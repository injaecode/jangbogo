...
public class AnswerController {
    ...
    public void answerCreate(@RequestBody AnswerDto answerDto, @PathVariable("id") Long id, BindingResult bindingResult,
        ...
        try {
            ...
            if (answerDto.getParentId() == null) { // 댓글 생성
                ...
                this.answerService.createChildReply(question, answerDto.getParentId().getId(), answerDto.getContent(),
                        member);
            }
