...
import com.jangbogo.dto.payload.response.DM.Response;
...
public class MessageController {
    ...
    public Response receiveMessage(@PathVariable Long id, @CurrentUser UserPrincipal userPrincipal)
            throws MemberNotEqualsException {
        Member member = memberRepository.findById(userPrincipal.getId())
                .orElseThrow(() -> new UsernameNotFoundException("유저 정보를 찾을 수 없습니다."));
    ...
    public Response sendMessage(@PathVariable Long id, @CurrentUser UserPrincipal userPrincipal)
            throws MemberNotEqualsException {
        Member member = memberRepository.findById(userPrincipal.getId())
                .orElseThrow(() -> new UsernameNotFoundException("유저 정보를 찾을 수 없습니다."));
    ...
    public Response deleteReceiveMessage(@PathVariable Long id, @CurrentUser UserPrincipal userPrincipal)
            throws MemberNotEqualsException {
        Member member = memberRepository.findById(userPrincipal.getId())
                .orElseThrow(() -> new UsernameNotFoundException("유저 정보를 찾을 수 없습니다."));
    ...
    public Response deleteSendMessage(@PathVariable Long id, @CurrentUser UserPrincipal userPrincipal)
            throws MemberNotEqualsException {
        Member member = memberRepository.findById(userPrincipal.getId())
                .orElseThrow(() -> new UsernameNotFoundException("유저 정보를 찾을 수 없습니다."));
