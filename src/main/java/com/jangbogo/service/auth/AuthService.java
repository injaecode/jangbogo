...
import com.jangbogo.dto.payload.request.auth.*;
...
public class AuthService {
    ...
    public ResponseEntity<?> delete(UserPrincipal userPrincipal) {
        ...
        ApiResponse apiResponse = ApiResponse.builder().check(true)
                .information(Message.builder().message("회원 탈퇴하셨습니다.").build()).build();
    ...
    public ResponseEntity<?> signin(SignInRequest signInRequest) {
        ...
        AuthResponse authResponse = AuthResponse.builder().accessToken(tokenMapping.getAccessToken())
    ...
    public ResponseEntity<?> signup(SignUpRequest signUpRequest) {
        ...
        ApiResponse apiResponse = ApiResponse.builder().check(true)
                .information(Message.builder().message("회원가입에 성공하였습니다.").build()).build();
    ...
    public ResponseEntity<?> refresh(RefreshTokenRequest tokenRefreshRequest) {
        ...
        AuthResponse authResponse = AuthResponse.builder().accessToken(tokenMapping.getAccessToken())
                .refreshToken(updateToken.getRefreshToken()).build();
    ...
    public ResponseEntity<?> signout(RefreshTokenRequest tokenRefreshRequest) {
        ...
        tokenRepository.delete(token.get());
        ApiResponse apiResponse = ApiResponse.builder().check(true)
                .information(Message.builder().message("로그아웃 하였습니다.").build()).build();
